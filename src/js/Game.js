...
function Game() {
    ...
    const [useBigGrid, setUseLargeGrid] = useState(false);
    const [gameIsPaused, toggleGameIsPaused] = useToggle();
    ...
    const [tiles, setTiles] = useState([1,1,2,2]);
    ...
    return (
        <div className="Game">
            <div className="game__header">
                ...
                <button onClick={() => setGameIsStarted(false)}>New Game</button>
                <button onClick={() => toggleGameIsPaused()}>Menu</button>
            </div>
            {gameIsStarted ? 
            ...
            <StartMenu 
                ...
                setUseLargeGrid={setUseLargeGrid}
