    ...
    return(
        <div className="StartMenu">
            ...
            <div className="StartMenu__container">
                ...
                <div className="StartMenu__theme-container">
                    <button onClick={() => props.setUseIcons(false)}>Numbers</button>
                    <button onClick={() => props.setUseIcons(true)}>Icons</button>
                </div>
                <label>Number of Players</label>
                <div className="StartMenu__players-container">
                    <button onClick={() => props.setNumPlayers(1)}>1</button>
                    <button onClick={() => props.setNumPlayers(2)}>2</button>
                    <button onClick={() => props.setNumPlayers(3)}>3</button>
                    <button onClick={() => props.setNumPlayers(4)}>4</button>
                </div>
                <label>Grid Size</label>
                <div className="StartMenu__grid-container">
                    <button onClick={() => props.setUseLargeGrid(false)}>4x4</button>
                    <button onClick={() => props.setUseLargeGrid(true)}>6x6</button>
                </div>
                <button onClick={() => props.setGameIsStarted(true)}>Start Game</button>
            </div>
        </div>
    )
}
